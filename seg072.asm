...
.l4adf:
	...
	db	0x11,0x88,0x46,0xec,0xb8,0x94,0x47,0x89,0x46,0xfc,0x8c,0x5e,0xfe
	push	word [bp+0x12]
	push	word [bp+0x10]
	push	ds
	push	ax
	db	0x9a,0x7f,0x19,0xee,0x18,0x8b,0x46,0xfc,0x8b,0x56,0xfe
	...
	axpush	0x8
	pushgvarptr 0x1634
	db	0xff,0x76,0xf2,0xff,0x76,0xf0,0x9a,0x7c,0x13,0x55,0x00,0x83,0xc4,0x0a
	or_ax_ax
	...
	db	0x06,0x11,0xc7,0x46,0xee,0x01,0x00,0x80,0x7e,0xea,0x03,0x75,0x75
	axpush	0x6
	pushgvarptr 0x162e
	...
	push	bp
	mov_bp_sp
	db	0x83,0xec,0x02,0xc4,0x5e,0x08,0x26,0xff,0x77,0x04,0x26,0xff,0x77,0x02
	pushlvarptr 0x2
	db	0x9a,0x68,0x16,0xee,0x18,0xf6,0x46,0xfe,0x01,0x75,0x2e,0x80,0x7e
	...
	db	0x76,0x0e,0xff,0x76,0x0c,0xff,0x76,0x0a
	pushlvarptr 0x6
	pushlvarptr 0x8
	pushlvarptr 0x4
	db	0x0e,0xe8,0x3b,0x00,0x3d,0x01,0x00,0x75,0x10
	call_318a2 5,46,0
	...
	db	0x46,0xfa,0x8c,0x56,0xfc,0xff,0x76,0x08,0xff,0x76,0x06
	pushlvarptr 0x2
	db	0x9a,0xe5,0x14,0xee,0x18
	or_ax_ax
	db	0x75,0x14,0xff,0x76,0x08,0xff,0x76,0x06
	pushlvarptr 0x1
	db	0x9a,0xe5,0x14,0xee,0x18
	or_ax_ax
	db	0x74,0x10
	...
	db	0xc0,0x75,0x06,0x8a,0x46,0xfe,0x98,0xeb,0x10
	call_318a2 5,38,0
	mov_sp_bp
	pop	bp
	retf	0x4
	...
	push	bp
	mov_bp_sp
	db	0x83,0xec,0x02,0xff,0x76,0x0c,0xff,0x76,0x0a
	pushlvarptr 0x2
	...
	db	0xf6,0x89,0x56,0xf8,0x0b,0xd0,0x75,0x0e
	axpush	0x5
	axpush2	0x1
	db	0x9a,0xb2,0x00,0x7f,0x21,0xc7,0x46,0xfa,0x00,0x00,0xe9,0xf5,0x00,0xff,0x76
	db	0x0c,0xff,0x76,0x0a
	pushlvarptr 0x2
	db	0x9a,0xfd,0x16,0xee,0x18,0x89,0x46
	db	0xf2,0x89,0x56,0xf4,0x0b,0xd0,0x75,0x10
	call_318a2 5,40,0
	db	0x83,0x7e,0xfe,0x00,0x75,0x50,0xff,0x76
	db	0x0c,0xff,0x76,0x0a
	pushlvarptr 0x4
	db	0x9a,0xe5,0x14,0xee,0x18
	or_ax_ax

...
sub_2b7da:
	...
	pushgvarptr 0x1562
	db	0xe8,0xc3,0xfe,0x5d,0xca,0x04,0x00
	...
	pushgvarptr 0x1562
	db	0xe8,0x3a,0xff,0x5d,0xca,0x04,0x00
	...
	sub_ax_ax
	db	0x26,0x89,0x47,0x02,0x26,0x89,0x07,0x8b,0x46,0x0e
	or_ax_ax
	db	0x75,0x03,0xe9,0xf8
	...
	or_ax_ax
	db	0x75,0x0b,0xc7,0x46,0xf6,0x00,0x00,0xff,0x06,0x54,0x15,0xeb,0x11,0xc4
	...
	db	0xc4,0x04,0xc4,0x5e,0x06,0x26,0x89,0x07,0xff,0x76,0xfe,0xff,0x76,0xfc
	axpush	0x1
	axpush	0x0
	db	0x9a,0x89,0x0a,0xee,0x18,0xc7,0x46,0xf6,0x00,0x00,0xff
	...
	pushlvarptr 0x4
	pushlvarptr 0x6
	db	0x0e,0xe8,0x1d,0xfe,0x0b,0xd0,0x75,0x05,0xb8,0x04,0x00,0xeb,0x02
	sub_ax_ax
	mov_sp_bp
	pop	bp
	retf	0x2
	...
	axpush	0x0
	pushlvarptr 0x2
	db	0x9a,0xe5,0x02,0x43,0x1d,0xa3,0x5c,0x15
	or_ax_ax
	db	0x74,0x0d,0x50
	db	0x9a,0x60,0x00,0x43,0x1d,0xa3,0x5e,0x15,0x89,0x16,0x60,0x15,0x8b,0x46,0xfe
	mov_sp_bp
	pop	bp
	retf	0x4
